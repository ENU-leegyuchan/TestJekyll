...
<div>
<img src = "./assets/login.png" width="550" height="300">
</div>
...
<img src="./assets/Management_CreateTable.png" width="400" height="500">
...
<img src="./assets/Management_CreateTable_2.png" width="600" height="700">
...
<img src = "./assets/Mypage.png" width="600" height="600">
...
#### 디바이스 통신 Run / Stop
<img src = "./assets/Run_Stop.png" width="600" height="150">
...
#### 디바이스 통신 주기 (SLAVE)
<img src = "./assets/Slave_Interval.png" width="600" height="150">

#### 태그리스트 (Edit)

<img src = "./assets/Tag_List_Edit.png" width="600" height="400">
...
#### 태그리스트 (Run)
<img src = "./assets/Tag_List.png" width="600" height="350">

> Set : 해당 핀을 어느 수치로 제어할 것인지에 대한 입력 창입니다.

<img src = "./assets/Set_Input.png" width="600" height="350">
